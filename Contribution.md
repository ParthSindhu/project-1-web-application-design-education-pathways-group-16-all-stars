...
- Reporting a bug (Please create a github issue)
...
1. Fork the repo and create your branch from `master`. Branch names should begin with feature, followed by the feature added OR bugfix folllowed by the bug bieng fixed
2. Pull Requests should reference the appropriate issue from github projects. (Convert task from Draft to issue)
3. If you've added code that should be tested, add tests.
4. If you've changed APIs, update the documentation.
5. Ensure the test suite passes.
6. Make sure your code lints. (pylint, prettier)
...
For javasript code we will be using Prettier
